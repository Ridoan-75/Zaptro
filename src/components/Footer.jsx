  ...
  return (
    <footer className='bg-gray-900 text-gray-200 py-10'>
        <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
            ...
            {/* coustomer service link */}
            <div className='mb-6  md:mb-0'>
                <h3 className='text-xl font-semibold'> Coustomer Service</h3>
            ...
            <div>
                ...
                <p className='mt-2 text-sm'>Subscribe to get special offers, free giveawaysm and more</p>
                <form action="" className='mt-4 flex'>
                    <input type="email" placeholder='Your email adress' className='w-full rounded-l-md text-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500' />
