  ...
  return (
    <div className='min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20'>
      <div className='max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8'>
        <h1 className='text-4xl font-bold'>About Zaptro</h1>
        ...
        <div className='space-y-6'>
         ...
         <Link to={'/product'}><button className="bg-red-600 text-white px-6 py-2 rounded-xl hover:bg-red-700 transition duration-300 cursor-pointer">
            Start Shopping
          </button></Link> 
        </div>
      </div>
